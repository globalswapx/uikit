...
var Icon$r = function (props) {
    return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", role: "img" }, props),
        React.createElement("g", { id: "Layer_2", "data-name": "Layer 2" },
            React.createElement("g", { id: "Layer_1-2", "data-name": "Layer 1" },
                React.createElement("circle", { cx: 12, cy: 12, r: 12, style: {
                        fill: "#f7931e",
                    } }),
                React.createElement("path", { d: "M9.39,19.52c-2.87.73-4-.68-3.61-2.33a6.54,6.54,0,0,1,1.68-2.74c2.48-2.74,7.69-5.86,12.82-8-3.9,2.2-9,5.62-11.36,9.51C8.17,17.13,7.7,19,9.39,19.52Z", style: {
                        fill: "#ffecd3",
                        fillRule: "evenodd",
                    } }),
                React.createElement("path", { d: "M6.37,12.35a50.22,50.22,0,0,1,6-2.61C7.31,12,3.79,15.57,5.67,16.66c-1,0-1.62-.29-1.84-.77-.43-.9.44-2,1.18-2.6l0,0a8.24,8.24,0,0,1-.06-1.22,7.29,7.29,0,0,1,12.33-5c-.5.21-1,.42-1.47.64a5.77,5.77,0,0,0-3.36-1.21,5.85,5.85,0,0,0-6.06,5.63Z", style: {
                        fill: "#ffecd3",
                        fillRule: "evenodd",
                    } }),
                React.createElement("path", { d: "M9.21,17.37a2.86,2.86,0,0,0,.18,1.72,7.46,7.46,0,0,0,2.84.57,7.3,7.3,0,0,0,7.3-7.3,7.21,7.21,0,0,0-1.1-3.85c-.39.25-.79.52-1.2.82a35.32,35.32,0,0,0-5.52,5.21h1.8a26.55,26.55,0,0,1,4.32-3.89,5.59,5.59,0,0,1,.25,1.7,5.85,5.85,0,0,1-8.87,5Z", style: {
                        fill: "#ffecd3",
                        fillRule: "evenodd",
                    } })))));
};
...
var Icon$$ = function (props) {
    return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 2268.17 2268.17", role: "img" }, props),
        React.createElement("g", { id: "Layer_2", "data-name": "Layer 2" },
            React.createElement("g", { id: "Layer_1-2", "data-name": "Layer 1" },
                React.createElement("circle", { cx: 1134.09, cy: 1134.09, r: 1134.09, style: {
                        fill: "#f7931e",
                    } }),
                React.createElement("path", { d: "M887.19,1844.78C615.73,1913.91,510.8,1780.52,545.81,1625c20.73-92.1,88.08-180.87,159.31-259.45C939.54,1107,1431.38,811.41,1917,604.69c-368.53,208.48-848,531.35-1074,898.52C771.76,1619,728,1795,887.19,1844.78Z", style: {
                        fill: "#ffecd3",
                        fillRule: "evenodd",
                    } }),
                React.createElement("path", { d: "M602,1166.83c153.6-77.6,378.65-183.2,567.85-245.86-479.44,216.37-811.53,550.15-633.6,653.66-95.59,0-153.24-27.33-174.49-72.63-40-85.26,41.46-184.57,111.58-245.74l-1.94,1.68a695.9,695.9,0,0,1-5.37-115.43c13.81-380.52,333.49-677.78,714-663.95a686.93,686.93,0,0,1,451.45,190.66q-71.23,29-139.14,60.06A550.37,550.37,0,0,0,1175.13,614.9c-305.21-11.09-561.64,227.35-572.72,532.57Q602.06,1157.21,602,1166.83Z", style: {
                        fill: "#ffecd3",
                        fillRule: "evenodd",
                    } }),
                React.createElement("path", { d: "M870.11,1641.47c-8.21,56-7.48,114.16,17.6,162.3a687.34,687.34,0,0,0,268.09,54c380.93,0,689.73-308.79,689.73-689.72a686.52,686.52,0,0,0-103.86-364.17c-37.16,23.66-74.92,49.67-112.94,77.72-173.3,127.8-367.43,311-522.27,492.8l170.3.44c117.89-135,282.41-279.22,408.17-367.44,16.24,52,23.7,103.26,23.7,160.65,0,305.31-247.5,552.82-552.83,552.82A550.18,550.18,0,0,1,870.11,1641.47Z", style: {
                        fill: "#ffecd3",
                        fillRule: "evenodd",
                    } })))));
};
